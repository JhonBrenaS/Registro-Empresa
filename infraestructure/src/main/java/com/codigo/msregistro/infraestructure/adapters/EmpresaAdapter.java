...
//NOS DARA LA FUNCIONALIDAD A NUESTRO PUERTO DE SALIDA
@Service
...
public class EmpresaAdapter implements EmpresaServiceOut {
    ...
    public EmpresaDTO deleteOut(Long id) {
        ...
        if(existe){
            ...
            entity.get().setUsuarioElimina(Constants.AUDIT_ADMIN);
    ...
    private EmpresaEntity getEntity(ResponseSunat sunat, RequestEmpresa requestEmpresa){
        ...
        entity.setNumeroDocumento(sunat.getNumeroDocumento());
        entity.setRazonSocial(sunat.getRazonSocial());
        entity.setEstado(Constants.STATUS_ACTIVE);
        entity.setUsuarioCrea(Constants.AUDIT_ADMIN);
    ...
    private EmpresaEntity getEntityUpdate(ResponseSunat sunat, EmpresaEntity empresaActualizar){
        ...
        empresaActualizar.setUsuarioModifica(Constants.AUDIT_ADMIN);
        empresaActualizar.setFechaModificacion(getTimestamp());
